...
class Engine {
  ...
  isValidElement(element) {
    return React.isValidElement(element) || (element.prototype && element.prototype.isReactComponent);
  }
  ...
  renderElement(reactElement, locals, options) {
    ...
    if (!this.isValidElement(reactElement) && typeof reactElement.then === 'function') {
